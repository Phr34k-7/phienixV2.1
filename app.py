...
os.environ['UAUTHLIB_INSECURE_TRANSPORT'] = '1'

# Clave secreta para sesiones
app.secret_key = "advpjsh"

# Configuración de MongoDB Atlas
client = MongoClient("mongodb+srv://phoenixsoftwarecorporations:gabrielsancz1010@cluster0.cabk5.mongodb.net/db1?retryWrites=true&w=majority")
...
google_db = make_google_blueprint(
    client_id='140212081753-11is7toclgc57o1af7v96j6bdi5t5crf.apps.googleusercontent.com',
    client_secret='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',
...
app.register_blueprint(google_db, url_prefix="/google_login") # Flask-Dance usa "/google_login"
...
def google_login_callback():
    # Si el usuario ya esta autenticado redirecciona a la pagina principal
    ...
    if not resp.ok:
        flash("Error al obtener informacion de Google. Intenta nuevamente." "error")
    ...
    if 'email' not in user_info:
        flash("Error: Google no proporciono un email.", "error")
        return redirect(url_for('login'))
    ...
    if not user:
        ...
        collection.insert_one({
            ...
            'google_id': google_id # Guardamos el ID unico de Google
        })
